...
func (m Model) renderSettings() string {
	...
	options := []struct {
		...
		{Tr("settings_auth_devto"), getPlatformStatus(models.PlatformDevTo), true},
		{Tr("settings_auth_reddit"), getPlatformStatus(models.PlatformReddit), true},
		{Tr("settings_auth_hashnode"), getPlatformStatus(models.PlatformHashnode), true},
		{Tr("settings_auth_medium"), getPlatformStatus(models.PlatformMedium), true},
