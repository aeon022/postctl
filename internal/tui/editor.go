...
func (m Model) renderEditor() string {
	...
	if m.editorFocus == 4 {
		...
		bodyLabel = "➔ " + bodyLabel[2:]
	}
	builder.WriteString(bodyStyle.Render(bodyLabel) + "\n" + m.editorBody.View() + "\n\n")
	...
	// Help footer
	helpStr := "tab / shift+tab: Feld wechseln  ·  ←/→: Plattform ändern (Feld 1)  ·  esc: Abbrechen"
